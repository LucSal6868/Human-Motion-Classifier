...
def train_svm_classifier():
    ...
    #  PREPARE DATA (Uses imported function)
    def prepare_training_data(parsed_data_dict: Dict[str, np.ndarray]) -> tuple[np.ndarray, np.ndarray]:
    ...
    X, y = prepare_training_data(parsed_data_dict)
